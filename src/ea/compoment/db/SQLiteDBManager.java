...
import ea.compoment.db.entity.DBMapArrayList;
import ea.compoment.db.entity.DBMasterEntity;
import ea.compoment.db.entity.NVArrayList;
import ea.compoment.db.util.DBAnnoUtils;
import ea.compoment.db.util.SqlBuilderFactory;
import ea.compoment.db.util.sql.SqlBuilder;
...
public class SQLiteDBManager
{
	...
	// 数据库默认设置
	public static String DB_NAME; // 默认数据库名字
