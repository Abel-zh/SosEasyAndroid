 ...
 *******************************************************************************/
package ea.compoment.universalimageloader.core.imageaware;
 ...
 * through {@link ea.compoment.universalimageloader.core.ImageLoader ImageLoader}.
...
public interface ImageAware {
	 ...
	 * {@linkplain ea.compoment.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain ea.compoment.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain ea.compoment.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain ea.compoment.universalimageloader.core.DisplayImageOptions display options}.<br />
