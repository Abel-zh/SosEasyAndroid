...
import ea.framework.mvc.controller.command.base.ICommand;
import ea.framework.mvc.controller.command.queue.CommandQueueManager;
import ea.framework.mvc.model.IResponseListener;
import ea.framework.mvc.model.RequestEntity;
...
public class CommandExecutor
{
	 ...
	 */
	public void enqueueCommand(String commandKey, RequestEntity request,
	...
	public void enqueueCommand(ICommand command, RequestEntity request,
			IResponseListener listener) throws NoSuchCommandException
			{
				if (command != null)
				{
